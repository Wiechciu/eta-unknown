...
#@export var customers: Array[Party]
#@export var customers_dict: Dictionary[String, Party]
#@export var freight_forwarders: Array[Party]
#@export var freight_forwarders_dict: Dictionary[String, Party]
#@export var suppliers: Array[Party]
#@export var suppliers_dict: Dictionary[String, Party]
#@export var carriers: Array[Party]
#@export var carriers_dict: Dictionary[String, Party]
#@export var customs_agencies: Array[Party]
#@export var customs_agencies_dict: Dictionary[String, Party]
#@export var handling_agents: Array[Party]
#@export var handling_agents_dict: Dictionary[String, Party]
#@export var truckers: Array[Party]
#@export var truckers_dict: Dictionary[String, Party]
#
