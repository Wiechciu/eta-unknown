...
func _on_arrange_pickup_button_pressed() -> void:
	shipment.haulage.trucker_pickup = Trucker.all_specific_with_employees.pick_random()
...
func _on_arrange_delivery_button_pressed() -> void:
	shipment.haulage.trucker_delivery = Trucker.all_specific_with_employees.pick_random()
