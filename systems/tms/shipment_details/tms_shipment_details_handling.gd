...
func _on_arrange_export_handling_button_pressed() -> void:
	shipment.handling.handling_agent_export = HandlingAgent.all_specific_with_employees.pick_random()
	refresh()


func _on_arrange_import_handling_button_pressed() -> void:
	shipment.handling.handling_agent_import = HandlingAgent.all_specific_with_employees.pick_random()
	refresh()
