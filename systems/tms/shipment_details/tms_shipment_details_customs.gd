...
func _on_arrange_export_customs_button_pressed() -> void:
	shipment.customs.customs_agency_export = CustomsAgency.all_specific_with_employees.pick_random()
...
func _on_arrange_import_customs_button_pressed() -> void:
	shipment.customs.customs_agency_import = CustomsAgency.all_specific_with_employees.pick_random()
